  ...
  return (
    <Container>
      ...
      <Flex alignItems="flex-end" flexDirection="column">
        <StyledLinkExternal href="https://lois.zone" mb="8px">
          {t('Learn more about LOIS')}
        </StyledLinkExternal>
        <StyledLinkExternal href="https://bscscan.com/token/0xad09104083d182d067cae2a123c6f1b052d2ea42">
          {t('View Contract')}
        </StyledLinkExternal>
      </Flex>
    </Container>
