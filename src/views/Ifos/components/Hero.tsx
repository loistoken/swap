...
const getGradient = (isDark: boolean) => {
  if (isDark) {
    return 'repeating-linear-gradient(to right, #40aac9, #40aac9 40px, #3197b4 40px, #3197b4 80px)'
  }
      ...
      <StyledHero>
        <Container>
          ...
          <Text bold fontSize="20px">
            {t('You can buy new tokens and get part of the future success of brand new tokens.')}
          </Text>
        </Container>
      </StyledHero>
      <CurtainBottom />
